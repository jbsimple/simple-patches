...
document.head.innerHTML += '<link rel="stylesheet" href="https://www.bitterli.co/fs/work/recom-patches.css?v=' + Date.now() + '" type="text/css"/>';
...
if (window.location.href.includes('/products') || window.location.href.includes('/product/item')) {
    document.head.innerHTML += '<link rel="stylesheet" href="https://www.bitterli.co/fs/work/recom-patches-product.css?v=' + Date.now() + '" type="text/css"/>';
