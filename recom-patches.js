...
function injectGoods() {
    ...
    if (location.pathname.includes('/receiving/queues/listing') || location.pathname.includes('/products/new')) {
        ...
        loadPatchScript('recom-patches-listingPrefill.js');
        ...
        if (!panic && bgsrc !== null && bgsrc !== '') {
            ...
            if (container) {
                ...
                styleTag.textContent = `
                    ...
                    .ql-container.ql-snow, .form-control.form-control-solid, .form-select.form-select-solid { background-color: color-mix(in srgb, var(--bs-gray-100) 50%, transparent 50%) !important; }
                    .dropzone { background-color: color-mix(in srgb, var(--bs-primary-light) 50%, transparent 50%) !important; }
                    .form-control { background-color: color-mix(in srgb, var--bs-body-bg) 50%, transparent 50%) !important; }
                `;
...
function modifiedClockInit() {
	...
	if (recordTime_button) {
        ...
        if (task === 'Pictures' || task === 'Testing') {
            ...
            pictureTrackModalBtn.innerHTML = '<i class="bi bi-solid bi-chart-simple fs-2 mobilefix"></i><span class="mobilefix">Picture Productivity</span>';
