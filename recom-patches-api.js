...
async function groq(prompt, model = 'qwen/qwen3.6-27b') {
...
async function groq_desc_btn() {
    ...
    fireSwal('Custom Autofill Description', [`Model: ${response.model}<br>`,`<textarea class="form-control form-control-solid form-control-lg" style="height:400px;max-height:65vh;font-size:13px;text-align:left;resize:vertical;">${response.response}</textarea>`], 'success', false, "800px");
    return response;
}
...
async function groq_desc(title = null, description = null, category = null) {
    ...
    let prompt = [
        ...
        "- Feature bullet 3",
        "- Feature bullet 4",
        "- Feature bullet 5 (if applicable)",
        "- Feature bullet 6 (if applicable)",
